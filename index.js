...
// ================= ANIMATIONS (public Giphy URLs – replace with file_ids later) =================
const ANIMATIONS = {
  ...
  planeFlying: "https://media.giphy.com/media/26ufnwz3wDUli7GU0/giphy.gif",
...
// ================= UTIL FUNCTIONS (moved to top so they are always available) =================
...
bot.on("callback_query", async (q) => {
  ...
  if (data === "join_vip") {
    ...
    return bot.sendMessage(id, "Unlock full access:\n\n• All games\n• Reply in lounge\n• Private messages", {
