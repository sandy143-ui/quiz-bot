  ...
  bot.sendMessage(id, text, {
    ...
    reply_markup: {
      inline_keyboard: [
        ...
        [{ text: hasAccess(id) ? "💌 Couples Chat" : "💌 Couples Chat (VIP Only)", callback_data: hasAccess(id) ? "couples_request" : "no_access" }],
        [{ text: hasAccess(id) ? "🎲 Mini Game Fun" : "🎲 Mini Game (VIP Only)", callback_data: hasAccess(id) ? "mini_game" : "no_access" }]
      ]
    }
  });
});
